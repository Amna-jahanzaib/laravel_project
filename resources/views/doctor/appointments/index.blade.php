            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Appointment">
                ...
                @if($appointment->status!=0 && $appointment->status!=2)
                        ...
                        <tr data-entry-id="{{ $appointment->id }}">
                            ...
                            <td>
                            <a href="{{ route('doctor.appointments.show', $appointment->id) }}">AP_{{ $appointment->id ?? '' }}</a>                  
                            </td>
                            <td>
                            ...
                            <td>
                                @can('appointment_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('doctor.appointments.show', $appointment->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
