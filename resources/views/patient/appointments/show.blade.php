        ...
        <div class="row">
            ...
            <div class="card card-primary card-outline">
              ...
              @endif
                ...
                <h3 class="profile-username text-center">                    
                  <a  href="{{ route('patient.doctors.show', $appointment->doctor->id)}}" target="_blank">
                    {{ $appointment->doctor->first_name ?? '' }}</h3>
                  </a>
          ...
          <div class="col-md-9">
            <div class="card">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <button type="button" class="btn btn-success float-right" onclick="location.reload();location.href='{{route('patient.appointments.index')}}'">
                    Back
