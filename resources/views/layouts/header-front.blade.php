...
========================================================================== */
#contact {
  background: #3B3B3B url('{{asset('dist/img/contact-us.jpg')}}') no-repeat center center;
  background-size: cover;
  color: #ffffff;
}
#contact h2 {
...
.heading-bold  h1{
	margin:0px!important; font-size: 24px; font-weight: bold;
}

hr{
	width: 180px; border-color: #fff; 
}
...
">
          ...
          <li class="nav-item">
          <a href="{{route('patient.register')}}" class="nav-link">Register Patient</a>
          </li>
